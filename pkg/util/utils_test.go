...
func TestGetLocalkubeDownloadURL(t *testing.T) {
	argsList := [...]getTestArgs{
		{"v1.3.0",
			"https://storage.googleapis.com/minikube/k8sReleases/v1.3.0/localkube-linux-s390x", false},
		{"v1.3.3",
			"https://storage.googleapis.com/minikube/k8sReleases/v1.3.3/localkube-linux-s390x", false},
